...
plot for [name in names_in] name.".dat" using 1:2 with lines lw 6 title "CAS attempts (".name.")"
set output name_out."-numSuccess.pdf"
plot for [name in names_in] name.".dat" using 1:3 with lines lw 6 title "CAS successes (".name.")"
